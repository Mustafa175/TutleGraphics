...
public class TurtleGraphics {
    ...
    public static void main(String... args) {
        ...
        System.out.printf(":========================:%n");
        System.out.printf("Your commands are%n %-8d%s%n %-8d%s%n %-8d%s%n %-8d%s%n" +
                " %-8s%s%n %-8d%s%n %-8d%s%n%n", 1, "Pen Up", 2, "Pen Down", 3,
                "Turn Right", 4, "Turn Left", "5, 10", "Move forward 10 spaces " +
                        "( replace 10 for differnt number of spaces )",
                6, "Display 20-by-20 array", 9, "End of data (sentinel )");
